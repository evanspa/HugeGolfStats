...
<h2><bean:message key="round.edit.page2.header" /></h2>
<html:form styleId="mainForm" action="/secure/EditRound-page2-submit" onsubmit="return validateCreateAccountForm(this);">

...
<script language="JavaScript">
	...
	function countrySelected() {
	    ...
	    if (selectedCountry == <%= Constants.ANY_OPTION_VAL %>) {
	    	...
	    	formObj.action="Refresh-EditRound-search.do?<%= AttributeKeyConstants.COUNTRY_CHANGED %>=<%= Constants.TRUE %>";
	    	formObj.submit();
	    }		
	}	
</script>
...
<h2><bean:message key="round.edit.search.header" /></h2>
<br />
<html:form styleId="mainForm" focus="courseName" action="/secure/EditRound-search-results">

...
<script language="JavaScript">
	...
	function start() {
		...
		formObj.action="Previous-EditRound-page1.do";
		formObj.submit();
	}

	function previous() {
		var formObj = document.getElementById("mainForm");
		formObj.action="EditRound-page1-submit.do";
		formObj.submit();
	}
...
<h2><bean:message key="round.edit.page3.header" /></h2>
<html:form styleId="mainForm" action="/secure/EditRound-page3-submit" onsubmit="return validateCreateAccountForm(this);">

...
<script language="JavaScript">
	...
	function countrySelected() {
		var formObj = document.getElementById("mainForm");
		formObj.action="Refresh-AddCourse-page1-submit.do?<%= AttributeKeyConstants.COUNTRY_CHANGED %>=<%= Constants.TRUE %>"
		formObj.submit();
	}
</script>
...
<h2><bean:message key="course.add.page2.header" /></h2>
<br />
<html:form styleId="mainForm" focus="courseName" action="/secure/AddCourse-page2-submit" onsubmit="return validateCreateAccountForm(this);">

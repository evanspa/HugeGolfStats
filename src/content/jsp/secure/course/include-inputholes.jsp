			...
			<table>
				...
				<tr>
					...
					<c:forEach var="j" begin="${startingHole}" end="${startingHole+8}">
						<td style="text-align:center;background-color:#FFFFCC;border: medium solid #FFF;font-weight:bold;padding:5px">${j}</td>
					</c:forEach>
					...
					<tr>
						...
						<c:forEach var="j" begin="${startingHole}" end="${startingHole+8}">
							<td style="padding:5px">
								<html:select property="parValue(${tee.value}-${j})" styleClass="holecombo">

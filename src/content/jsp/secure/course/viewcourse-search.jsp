...
<script language="JavaScript">
	...
	function countrySelected() {
		var formObj = document.getElementById("mainForm");
		formObj.action="Refresh-ViewCourse-search.do?<%= AttributeKeyConstants.COUNTRY_CHANGED %>=<%= Constants.TRUE %>"
		formObj.submit();
	}
</script>
...
<h2><bean:message key="course.view.search.header" /></h2>
<br />
<html:form styleId="mainForm" focus="courseName" action="/secure/ViewCourse-search-results">

...
<script language="JavaScript">
	...
	function previous() {
		var formObj = document.getElementById("mainForm");
		formObj.action="EditCourse-page1-submit.do";
		formObj.submit();
	}
...
<h2><bean:message key="course.edit.page3.header" /></h2>
<br />
<html:form styleId="mainForm" focus="courseName" action="/secure/EditCourse-page3-submit" onsubmit="return validateCreateAccountForm(this);">

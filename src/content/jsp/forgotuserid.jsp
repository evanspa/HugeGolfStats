...
<h2><bean:message key="forgotuserid.header" /></h2>
<br />
<html:form styleId="mainForm" focus="monthNumber" action="/ForgotUserId-submit">
<table class="form-table">
	...
	<tr>
		<th style="width:${thwidth}"><bean:message key="profile.emailaddress" /><span class="required">*</span></th>
		<td><html:text property="emailAddress" size="45" styleClass="field" /></td>
	</tr>
</table>
<p>

 ...
 *
 */
public class RefreshPostRoundAction extends BaseAction {
	
	// logger object...
	private final static Logger logger = Logger.getLogger(
			RefreshPostRoundAction.class);
	...
	public ActionForward executeAction(ActionMapping aMapping,
		...
		httpSession.setAttribute(AttributeKeyConstants.COURSES, 
				courses = getDAOUtils().getCourses(form.getCountryId(),
						form.getStateProvinceId()));
		
		// prepare the holes-played info...
		PreparePostRoundAction.prepareHolesPlayed(httpSession, getDAOUtils(), 
				getUtil(), form, aRequest, null, courses);

...
import name.paulevans.golf.bean.chart.aroundgreen.UpDownConversionPercentageTrend;
 ...
 *
 */
public class PrepareAroundGreenStatsAction extends StatsAdapterAction {
	...
	public void hook(StatisticsForm aForm, HttpServletRequest aRequest) {
		...
		aForm.setChartClass(UpDownConversionPercentageTrend.class.getName());
	}
}
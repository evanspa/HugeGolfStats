...
public class Num4PuttsPerRoundTrend extends ChartAdapter {
	...
	public JFreeChart getChart(Date aFromDate, Date aToDate, 
		...
		return ChartUtils.newNumPuttsChart(aFromDate, aToDate, 
				aCircumstances, aDAOUtils, aPlayer, 4, false, true, 
				"chart.numputtstimechart.4putts", 
				"chart.num4puttstimechart.title", getLabelStringFactory());	
	}
}

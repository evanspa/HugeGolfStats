...
public class NumPuttsGIRPerHolePie extends ChartAdapter {
	...
	public JFreeChart getChart(Date aFromDate, Date aToDate, 
		...
		return ChartUtils.newNumPuttsPieChart(aFromDate, aToDate, 
				aCircumstances, aDAOUtils, aPlayer, true, getLabelStringFactory());
	}
}

...
public class Num4PuttsGIRPerRoundTrend extends ChartAdapter {
	...
	public JFreeChart getChart(Date aFromDate, Date aToDate, 
		...
		return ChartUtils.newNumPuttsChart(aFromDate, aToDate, 
				aCircumstances, aDAOUtils, aPlayer, 4, true, true, 
				"chart.numputtsgirtimechart.4putts", 
				"chart.num4puttsgirtimechart.title", getLabelStringFactory());		
	}
}

...
public class Num0PuttsPerRoundTrend extends ChartAdapter {
	...
	public JFreeChart getChart(Date aFromDate, Date aToDate, 
		...
		return ChartUtils.newNumPuttsChart(aFromDate, aToDate, 
				aCircumstances, aDAOUtils, 
				aPlayer, 0, false, false, "chart.numputtstimechart.0putts", 
				"chart.num0puttstimechart.title", getLabelStringFactory());		
	}
}

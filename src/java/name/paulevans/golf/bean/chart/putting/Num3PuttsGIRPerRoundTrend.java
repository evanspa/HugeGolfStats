...
public class Num3PuttsGIRPerRoundTrend extends ChartAdapter {
	...
	public JFreeChart getChart(Date aFromDate, Date aToDate, 
		...
		return ChartUtils.newNumPuttsChart(aFromDate, aToDate, 
				aCircumstances, aDAOUtils, aPlayer, 3, true, false, 
				"chart.numputtsgirtimechart.3putts", 
				"chart.num3puttsgirtimechart.title", getLabelStringFactory());		
	}
}
